...
- **Bundle lookup and inspection:** [DTMT](https://git.sclu1034.dev/bitsquid_dt/dtmt/releases/) locates resources through the game's existing bundle database and lists bundle contents. Its Windows build requires `oo2core_9_win64.dll`. It uses a CSV dictionary, unlike limn's plain-text dictionary; hash-based inspection does not require known names.
